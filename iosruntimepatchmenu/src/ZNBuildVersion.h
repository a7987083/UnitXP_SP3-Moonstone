...
#define ZN_MILESTONE_VERSION @"M5.0"
#define ZN_MENU_VERSION_DISPLAY @"0.5.8 · M5.0"
#define ZN_MENU_VERSION_FEATURE @"Managed-reference Return Chaining + Generic Invoke"
