...
#define ZN_MILESTONE_VERSION @"M4.9"
#define ZN_MENU_VERSION_DISPLAY @"0.5.8 · M4.9"
#define ZN_MENU_VERSION_FEATURE @"Generic Invoke + Runtime Editable Args + Return Capture"
